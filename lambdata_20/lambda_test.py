...
from oop_assignment import Person

class PersonTests(unittest.TestCase):
    """
    Test for registering a person for etc
    """
    def application(self):
        self.person1 = Person("Bobby", 42, "b", "green")

    def test_person(self):
        """
        Testing if name is string
        """
        self.assertEqual(self.person1.name, str)
